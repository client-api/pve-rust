...
pub struct QemuUpdateVmAsyncOpRequest {
    ...
    pub background_delay: Option<i32>,
...
impl QemuUpdateVmAsyncOpRequest {
    pub fn new() -> QemuUpdateVmAsyncOpRequest {
...
impl serde::Serialize for QemuUpdateVmAsyncOpRequest {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        {
            let _v = serde_json::to_value(&self.background_delay).map_err(Error::custom)?;
            if !_v.is_null() {
                map.insert("background_delay".to_string(), _v);
            }
        }
...
impl<'de> serde::Deserialize<'de> for QemuUpdateVmAsyncOpRequest {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        Ok(QemuUpdateVmAsyncOpRequest {
            ...
            background_delay: serde_json::from_value(raw.remove("background_delay").unwrap_or(serde_json::Value::Null)).map_err(Error::custom)?,
