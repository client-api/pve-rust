...
pub struct NodesStorageGetImportMetadataResponseData {
    ...
    #[serde(rename = "type")]
    pub r#type: models::PveNodesStorageTypeEnum2,
...
impl NodesStorageGetImportMetadataResponseData {
    pub fn new(create_args: serde_json::Value, source: models::PveNodesStorageSourceEnum, r#type: models::PveNodesStorageTypeEnum2) -> NodesStorageGetImportMetadataResponseData {
