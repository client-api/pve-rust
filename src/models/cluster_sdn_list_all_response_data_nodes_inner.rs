...
pub struct ClusterSdnListAllResponseDataNodesInner {
...
impl ClusterSdnListAllResponseDataNodesInner {
    pub fn new(fabric_id: String, interfaces: Vec<serde_json::Value>, node_id: String, protocol: models::PveProtocolEnum) -> ClusterSdnListAllResponseDataNodesInner {
