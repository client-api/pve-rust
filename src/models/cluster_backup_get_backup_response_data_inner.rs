...
pub struct ClusterBackupGetBackupResponseDataInner {
    ...
    pub fleecing: Option<Box<models::ClusterBackupGetBackupResponseDataInnerFleecing>>,
    ...
    pub performance: Option<Box<models::ClusterBackupGetBackupResponseDataInnerPerformance>>,
    ...
    pub prune_backups: Option<Box<models::ClusterBackupGetBackupResponseDataInnerPruneBackups>>,
    ...
    #[serde(rename = "repeat-missed", skip_serializing_if = "Option::is_none")]
    pub repeat_missed: Option<models::PveBoolean>,
