...
pub struct ClusterReplicationGetReplicationResponseDataInner {
...
impl ClusterReplicationGetReplicationResponseDataInner {
    pub fn new(guest: i64, id: String, jobnum: i64, target: String, r#type: models::PveClusterReplicationTypeEnum) -> ClusterReplicationGetReplicationResponseDataInner {
