...
pub struct PveQemuVirtioConfig {
...
impl PveQemuVirtioConfig {
    pub fn new(file: String) -> PveQemuVirtioConfig {
        PveQemuVirtioConfig {
...
impl PveQemuVirtioConfig {
    /// Serialise this PveQemuVirtioConfig into Proxmox's CLI-style shorthand
