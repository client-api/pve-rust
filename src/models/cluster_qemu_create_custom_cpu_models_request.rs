...
pub struct ClusterQemuCreateCustomCpuModelsRequest {
    ...
    pub reported_model: models::PveReportedModelEnum,


}

impl ClusterQemuCreateCustomCpuModelsRequest {
    pub fn new(cputype: String, reported_model: models::PveReportedModelEnum) -> ClusterQemuCreateCustomCpuModelsRequest {
