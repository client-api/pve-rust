...
pub struct QemuVmConfigResponseData {
    ...
    pub agent: Option<Box<models::PveQemuAgentField>>,
    ...
    pub arch: Option<models::PveQemuArchEnum>,
    ...
    pub audio0: Option<Box<models::PveQemuAudioField>>,
    ...
    pub efidisk0: Option<Box<models::PveQemuEfidiskField>>,
    ...
    pub ivshmem: Option<Box<models::PveQemuIvshmemField>>,
    ...
    pub machine: Option<Box<models::PveQemuMachineField>>,

    /// Memory properties.
    pub memory: Option<Box<models::PveQemuMemoryField>>,

    /// Some (read-only) meta-information about this guest.
    pub meta: Option<Box<models::PveMetaField>>,
    ...
    pub runningmachine: Option<Box<models::PveQemuMachineField>>,
    ...
    pub spice_enhancements: Option<Box<models::PveQemuSpiceEnhancementsField>>,
    ...
    pub tpmstate0: Option<Box<models::PveQemuTpmstateField>>,
    ...
    pub vga: Option<Box<models::PveQemuVgaField>>,
    ...
    pub ides: Option<std::collections::HashMap<u32, models::PveQemuIdeField>>,
    ...
    pub nets: Option<std::collections::HashMap<u32, models::PveQemuNetField2>>,
    /// Numas family. Wire form: `numa0..numa7`. Serialised by the manual impls below.
    pub numas: Option<std::collections::HashMap<u32, models::PveQemuNumaField>>,
    ...
    pub satas: Option<std::collections::HashMap<u32, models::PveQemuSataField>>,
    /// Scsis family. Wire form: `scsi0..scsi30`. Serialised by the manual impls below.
    pub scsis: Option<std::collections::HashMap<u32, models::PveQemuScsiField>>,
    ...
    pub unuseds: Option<std::collections::HashMap<u32, models::PveQemuUnusedField2>>,
    /// Usbs family. Wire form: `usb0..usb4`. Serialised by the manual impls below.
    pub usbs: Option<std::collections::HashMap<u32, models::PveQemuUsbField>>,
    /// Virtiofs family. Wire form: `virtiofs0..virtiofs8`. Serialised by the manual impls below.
    pub virtiofs: Option<std::collections::HashMap<u32, models::PveQemuVirtiofsField>>,
    /// Virtios family. Wire form: `virtio0..virtio15`. Serialised by the manual impls below.
    pub virtios: Option<std::collections::HashMap<u32, models::PveQemuVirtioField>>,
}

impl QemuVmConfigResponseData {
    pub fn new(digest: String) -> QemuVmConfigResponseData {
...
impl serde::Serialize for QemuVmConfigResponseData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        ...
        {
            let _v = serde_json::to_value(&self.meta).map_err(Error::custom)?;
            if !_v.is_null() {
                map.insert("meta".to_string(), _v);
            }
        }
        ...
        {
            let _v = serde_json::to_value(&self.parent).map_err(Error::custom)?;
            if !_v.is_null() {
                map.insert("parent".to_string(), _v);
            }
        }
        ...
        {
            let _v = serde_json::to_value(&self.running_nets_host_mtu).map_err(Error::custom)?;
            if !_v.is_null() {
                map.insert("running-nets-host-mtu".to_string(), _v);
            }
        }
        
        {
            let _v = serde_json::to_value(&self.runningcpu).map_err(Error::custom)?;
            if !_v.is_null() {
                map.insert("runningcpu".to_string(), _v);
            }
        }
        
        {
            let _v = serde_json::to_value(&self.runningmachine).map_err(Error::custom)?;
            if !_v.is_null() {
                map.insert("runningmachine".to_string(), _v);
            }
        }
        ...
        {
            let _v = serde_json::to_value(&self.snaptime).map_err(Error::custom)?;
            if !_v.is_null() {
                map.insert("snaptime".to_string(), _v);
            }
        }
        ...
        {
            let _v = serde_json::to_value(&self.vmstate).map_err(Error::custom)?;
            if !_v.is_null() {
                map.insert("vmstate".to_string(), _v);
            }
        }
...
impl<'de> serde::Deserialize<'de> for QemuVmConfigResponseData {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        let mut __ides: std::collections::HashMap<u32, models::PveQemuIdeField> = std::collections::HashMap::new();
        {
            let _prefix = "ide";
            let _keys: Vec<String> = raw.keys()
                .filter(|k| {
            ...
            for _key in _keys {
                ...
                let _idx: u32 = _suffix.parse().map_err(Error::custom)?;
                let _value = raw.remove(&_key).unwrap();
                let _item: models::PveQemuIdeField = serde_json::from_value(_value).map_err(Error::custom)?;
        ...
        let mut __nets: std::collections::HashMap<u32, models::PveQemuNetField2> = std::collections::HashMap::new();
        {
            let _prefix = "net";
            let _keys: Vec<String> = raw.keys()
                .filter(|k| {
            ...
            for _key in _keys {
                ...
                let _idx: u32 = _suffix.parse().map_err(Error::custom)?;
                let _value = raw.remove(&_key).unwrap();
                let _item: models::PveQemuNetField2 = serde_json::from_value(_value).map_err(Error::custom)?;
                __nets.insert(_idx, _item);
            }
        }
        let mut __numas: std::collections::HashMap<u32, models::PveQemuNumaField> = std::collections::HashMap::new();
        {
            let _prefix = "numa";
            let _keys: Vec<String> = raw.keys()
                .filter(|k| {
            ...
            for _key in _keys {
                ...
                let _idx: u32 = _suffix.parse().map_err(Error::custom)?;
                let _value = raw.remove(&_key).unwrap();
                let _item: models::PveQemuNumaField = serde_json::from_value(_value).map_err(Error::custom)?;
        ...
        let mut __satas: std::collections::HashMap<u32, models::PveQemuSataField> = std::collections::HashMap::new();
        {
            let _prefix = "sata";
            let _keys: Vec<String> = raw.keys()
                .filter(|k| {
            ...
            for _key in _keys {
                ...
                let _idx: u32 = _suffix.parse().map_err(Error::custom)?;
                let _value = raw.remove(&_key).unwrap();
                let _item: models::PveQemuSataField = serde_json::from_value(_value).map_err(Error::custom)?;
                __satas.insert(_idx, _item);
            }
        }
        let mut __scsis: std::collections::HashMap<u32, models::PveQemuScsiField> = std::collections::HashMap::new();
        {
            let _prefix = "scsi";
            let _keys: Vec<String> = raw.keys()
                .filter(|k| {
            ...
            for _key in _keys {
                ...
                let _idx: u32 = _suffix.parse().map_err(Error::custom)?;
                let _value = raw.remove(&_key).unwrap();
                let _item: models::PveQemuScsiField = serde_json::from_value(_value).map_err(Error::custom)?;
        ...
        let mut __unuseds: std::collections::HashMap<u32, models::PveQemuUnusedField2> = std::collections::HashMap::new();
        {
            let _prefix = "unused";
            let _keys: Vec<String> = raw.keys()
                .filter(|k| {
            ...
            for _key in _keys {
                ...
                let _idx: u32 = _suffix.parse().map_err(Error::custom)?;
                let _value = raw.remove(&_key).unwrap();
                let _item: models::PveQemuUnusedField2 = serde_json::from_value(_value).map_err(Error::custom)?;
                __unuseds.insert(_idx, _item);
            }
        }
        let mut __usbs: std::collections::HashMap<u32, models::PveQemuUsbField> = std::collections::HashMap::new();
        {
            let _prefix = "usb";
            let _keys: Vec<String> = raw.keys()
                .filter(|k| {
            ...
            for _key in _keys {
                ...
                let _idx: u32 = _suffix.parse().map_err(Error::custom)?;
                let _value = raw.remove(&_key).unwrap();
                let _item: models::PveQemuUsbField = serde_json::from_value(_value).map_err(Error::custom)?;
                __usbs.insert(_idx, _item);
            }
        }
        let mut __virtiofs: std::collections::HashMap<u32, models::PveQemuVirtiofsField> = std::collections::HashMap::new();
        {
            ...
            for _key in _keys {
                ...
                let _idx: u32 = _suffix.parse().map_err(Error::custom)?;
                let _value = raw.remove(&_key).unwrap();
                let _item: models::PveQemuVirtiofsField = serde_json::from_value(_value).map_err(Error::custom)?;
                __virtiofs.insert(_idx, _item);
            }
        }
        let mut __virtios: std::collections::HashMap<u32, models::PveQemuVirtioField> = std::collections::HashMap::new();
        {
            let _prefix = "virtio";
            let _keys: Vec<String> = raw.keys()
                .filter(|k| {
            ...
            for _key in _keys {
                ...
                let _idx: u32 = _suffix.parse().map_err(Error::custom)?;
                let _value = raw.remove(&_key).unwrap();
                let _item: models::PveQemuVirtioField = serde_json::from_value(_value).map_err(Error::custom)?;
                __virtios.insert(_idx, _item);
            }
        }
        Ok(QemuVmConfigResponseData {
            ...
            meta: serde_json::from_value(raw.remove("meta").unwrap_or(serde_json::Value::Null)).map_err(Error::custom)?,
            ...
            parent: serde_json::from_value(raw.remove("parent").unwrap_or(serde_json::Value::Null)).map_err(Error::custom)?,
            ...
            running_nets_host_mtu: serde_json::from_value(raw.remove("running-nets-host-mtu").unwrap_or(serde_json::Value::Null)).map_err(Error::custom)?,
            
            runningcpu: serde_json::from_value(raw.remove("runningcpu").unwrap_or(serde_json::Value::Null)).map_err(Error::custom)?,
            
            runningmachine: serde_json::from_value(raw.remove("runningmachine").unwrap_or(serde_json::Value::Null)).map_err(Error::custom)?,
            ...
            snaptime: serde_json::from_value(raw.remove("snaptime").unwrap_or(serde_json::Value::Null)).map_err(Error::custom)?,
            ...
            vmstate: serde_json::from_value(raw.remove("vmstate").unwrap_or(serde_json::Value::Null)).map_err(Error::custom)?,
