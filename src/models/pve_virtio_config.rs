...
impl PveVirtioConfig {
    pub fn new(file: String) -> PveVirtioConfig {
        PveVirtioConfig {
...
impl PveVirtioConfig {
    /// Serialise this PveVirtioConfig into Proxmox's CLI-style shorthand
