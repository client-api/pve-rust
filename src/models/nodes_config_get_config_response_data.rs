...
pub struct NodesConfigGetConfigResponseData {
    ...
    pub acme: Option<Box<models::PveAcmeField>>,
    ...
    pub location: Option<Box<models::PveNodesConfigLocationField>>,
    ...
    pub wakeonlan: Option<Box<models::PveWakeonlanField>>,

    /// Acmedomains family. Wire form: `acmedomain0..acmedomain8`. Serialised by the manual impls below.
    pub acmedomains: Option<std::collections::HashMap<u32, models::PveAcmedomainField>>,
}
...
impl serde::Serialize for NodesConfigGetConfigResponseData {
...
impl<'de> serde::Deserialize<'de> for NodesConfigGetConfigResponseData {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use serde::de::Error;
        let mut raw: serde_json::Map<String, serde_json::Value> =
            serde::Deserialize::deserialize(deserializer)?;
        let mut __acmedomains: std::collections::HashMap<u32, models::PveAcmedomainField> = std::collections::HashMap::new();
        {
            ...
            for _key in _keys {
                ...
                let _item: models::PveAcmedomainField = serde_json::from_value(_value).map_err(Error::custom)?;
                __acmedomains.insert(_idx, _item);
            }
        }
        Ok(NodesConfigGetConfigResponseData {
