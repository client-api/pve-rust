...
pub struct ClusterFirewallUpdateRuleRequest {
    ...
    pub r#type: Option<models::PveClusterFirewallTypeEnum>,


}

impl ClusterFirewallUpdateRuleRequest {
    pub fn new() -> ClusterFirewallUpdateRuleRequest {
