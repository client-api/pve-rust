...
impl ClusterCephMetadataResponseDataMonValue {
    pub fn new(ceph_release: String, ceph_version: String, ceph_version_short: String, hostname: String, mem_swap_kb: i64, mem_total_kb: i64) -> ClusterCephMetadataResponseDataMonValue {
