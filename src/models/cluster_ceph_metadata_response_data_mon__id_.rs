...
/// ClusterCephMetadataResponseDataMonId : Useful properties are listed, but not the full list.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClusterCephMetadataResponseDataMonId {
...
impl ClusterCephMetadataResponseDataMonId {
    /// Useful properties are listed, but not the full list.
    pub fn new(addrs: String, ceph_release: String, ceph_version: String, ceph_version_short: String, hostname: String, mem_swap_kb: i64, mem_total_kb: i64, name: String) -> ClusterCephMetadataResponseDataMonId {
